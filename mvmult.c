/*
TIMING: 
on main(), the program will put current time to a variable.
Right before MPI_Finalize() and program termination, elapsed time is calculated using: 
